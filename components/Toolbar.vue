  ...
  <nav>
    ...
    >
      ...
      <ul
        ...
        class="hidden w-[50vw] items-center justify-between transition-all duration-200 md:flex"
      >
        <li v-for="page of pages">
          <NuxtLink :to="page" class="hover:lime-400 focus:lime-400 text-white"
            >{{ page }}
          </NuxtLink>
        </li>
      </ul>
      ...
      <button
        class="z-10 w-auto text-[4vh] text-white"
