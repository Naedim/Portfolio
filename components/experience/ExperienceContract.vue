<template>
    <div class="grid items-center w-full grid-cols-2 grid-rows-2 p-2 font-bold border-orange-300 md:w-3/4 sm:p-3 justify-items-center text-neutral-200 border-y-2 g-white">
